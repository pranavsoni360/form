                ...
                {documentsFor(formData.consumer_loan_type).map(doc => {
                  ...
                  <div className="flex items-center justify-between gap-3 p-4 rounded-xl"
                    ...
                    <div>
                      ...
                      {/* No bank picker: the Account Aggregator journey asks the
                          applicant to choose their bank and consent INSIDE the AA
                          screen, using the mobile number registered with that
                          bank. A dropdown here would be a second, redundant
