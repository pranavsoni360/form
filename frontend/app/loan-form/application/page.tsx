...
export default function LoanApplication() {
  ...
  const step1Valid = () => validate({ pan_number: 'Required', aadhaar_number: 'Required', full_name: 'Required', date_of_birth: 'Required', gender: 'Required', current_address: 'Required' });
          ...
          {currentStep === 1 && (
            <div className="space-y-5">
              ...
              <div className="grid grid-cols-2 gap-3">
                <F label="Middle Name"><input type="text" value={formData.middle_name || ''} onChange={e => onChange('middle_name', e.target.value)} className={inp('')} placeholder="Optional" /></F>
                <F label="Last Name" required><input type="text" value={formData.last_name || ''} onChange={e => onChange('last_name', e.target.value)} className={inp('')} placeholder="Last name" /></F>
              </div>
              <div className="grid grid-cols-2 gap-3">
