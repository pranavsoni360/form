        ...
        <div className="bg-white dark:bg-dark-card rounded-2xl shadow-lg dark:shadow-gray-900/50 p-4 sm:p-6 transition-colors">
          ...
          {currentStep === 3 && (
            <div className="space-y-5 animate-[fadeIn_0.3s_ease-out]">
              ...
              {formData.is_salaried !== undefined && formData.is_salaried !== null && (
                <div className="flex items-center gap-2 px-3 py-2 rounded-lg bg-green-50 dark:bg-green-900/20 border border-green-200 dark:border-green-700/40 text-sm text-green-800 dark:text-green-300">
                  <span className="font-semibold">Salaried Employee Confirmed:</span>
                  <span>{formData.is_salaried === true || formData.is_salaried === 'true' ? 'Yes' : 'No'}</span>
                  <span className="ml-auto text-xs bg-green-100 dark:bg-green-800/40 text-green-700 dark:text-green-400 px-2 py-0.5 rounded-full">Voice Call</span>
                </div>
              )}
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 sm:gap-4">
          ...
          {currentStep === 4 && (
            <div className="space-y-5 animate-[fadeIn_0.3s_ease-out]">
              ...
              {formData.individual_purpose !== undefined && formData.individual_purpose !== null && (
                <div className="flex items-center gap-2 px-3 py-2 rounded-lg bg-blue-50 dark:bg-blue-900/20 border border-blue-200 dark:border-blue-700/40 text-sm text-blue-800 dark:text-blue-300">
                  <span className="font-semibold">Individual Purpose Confirmed:</span>
                  <span>{formData.individual_purpose === true || formData.individual_purpose === 'true' ? 'Yes' : 'No'}</span>
                  <span className="ml-auto text-xs bg-blue-100 dark:bg-blue-800/40 text-blue-700 dark:text-blue-400 px-2 py-0.5 rounded-full">Voice Call</span>
                </div>
              )}
              <div className="bg-green-50 dark:bg-dark-section border border-green-200 dark:border-gray-700/50 rounded-xl p-4 space-y-4">
