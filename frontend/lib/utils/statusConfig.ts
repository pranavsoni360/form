...
export const STATUS_COLORS: Record<ApplicationStatus, string> = {
  ...
  officer_approved:    'bg-teal-100 text-teal-700 dark:bg-teal-900/30 dark:text-teal-300',
...
export const SUGGESTION_COLORS: Record<AISuggestion, string> = {
...
export function getSuggestionColor(suggestion: string): string {
  return SUGGESTION_COLORS[suggestion as AISuggestion] ?? '';
}